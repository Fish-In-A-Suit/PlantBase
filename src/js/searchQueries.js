...
var peperomiaSQ = [peperomiaReference, peperomiaDisplayName, peperomiaOtherNames]; //SQ = search query
...
var moneyplantSQ = [moneyPlantReference, moneyplantDisplayName, moneyplantOtherNames];
...
var zzplantSQ = [zzplantReference, zzplantDisplayName, zzplantOtherNames];
...
var aloeveraSQ = [aloeveraReference, aloeveraDisplayName, aloeveraOtherNames];
...
var snakeplantSQ = [snakeplantReference, snakeplantDisplayName, snakeplantOtherNames];
...
var crownofthornsSQ = [crownofthornsReference, crownofthornsDisplayName, crownofthornsOtherNames];
...
var scheffleraSQ = [scheffleraReference, scheffleraDisplayName, scheffleraOtherNames];
